...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BL] = LAYOUT_moonlander(
    xxxxxxxx,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                    xxxxxxxx,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           xxxxxxxx,
    KC_LCTL,        KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_7,                    xxxxxxxx,       KC_MS_WH_UP,    KC_MS_BTN1,     KC_MS_UP,       KC_MS_BTN2,     xxxxxxxx,       xxxxxxxx,
    KC_TAB,         KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_8,                    xxxxxxxx,       KC_MS_WH_DOWN,  KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    xxxxxxxx,       xxxxxxxx,
    KC_ESCAPE,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                    KC_MS_BTN3,     xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       KC_ENTER,
    KC_LCTL,        KC_LALT,        xxxxxxxx,       KC_LGUI,        KC_BSPC,                        xxxxxxxx,                xxxxxxxx,                       KC_SPACE,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,
                                                                                    KC_LALT,         KC_LSFT,KC_NO,   KC_NO,KC_SPACE,          KC_RCTL
  ),
  ...
  [_EMACS] = LAYOUT_moonlander(
    xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,                xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,
    xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       RGUI(KC_ENTER), xxxxxxxx,       xxxxxxxx,       xxxxxxxx,                xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       xxxxxxxx,       M_CC_P_F,       M_CC_P_P,       xxxxxxxx,
    RGUI(KC_TAB),   RGUI(KC_A),     RGUI(KC_S),     RGUI(KC_D),     RGUI(KC_F),     RGUI(KC_G),     xxxxxxxx,                xxxxxxxx,       LGUI(KC_H),     LGUI(KC_J),     LGUI(KC_K),     LGUI(KC_L),     xxxxxxxx,       xxxxxxxx,
